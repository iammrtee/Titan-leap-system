    ...
    <aside className="h-screen w-64 fixed left-0 top-0 flex flex-col bg-surface-container-low border-r-0 z-50 overflow-y-auto no-scrollbar">
      <div className="flex flex-col h-full py-6">
        ...
        <div className="mt-auto px-6 space-y-4">
          ...
          <button className="w-full py-3 px-4 bg-secondary-container text-on-secondary-fixed-variant font-bold rounded-xl text-sm flex items-center justify-center gap-2 shadow-sm hover:brightness-105 transition-all active:scale-95">
